# Project State
Last updated: 2026-04-13T00:29:32Z
Updated by: analyze.yml (weekly)

## Last Session
Action: analyze.yml weekly summary — Week of Apr 6-13. 423 commits (3 fix), 73 agent_log entries. All workflows HEALTHY, 11 consecutive watcher all-clears. Cost $138/wk (below $150 target). Research plateau: 17 PH 0-pattern, 30 HS 0-architecture. 22d+ human gap. 3 issues self-healed (#154/#156/#158). v0.5.0 released. Profile 4/6 stalled.

System health:
- Evolve: HEALTHY — turns 34-60, max 55. 6/29 (20.7%) exceed rate (below 30% threshold). 6h cadence.
- Watcher: HEALTHY — 0/92+ exceed max 50. Turns 19-32 recent. All Opus, 3/168 Haiku (1.8%). 11 consecutive all-clears.
...
1. **[READY]** Dependabot PRs: #133/#135/#136 — ALL PASSING, APPROVED, CLEAN/MERGEABLE, awaiting human merge 10d+. #1 watcher overhead source (80+ branch updates this week).
...
## Open Items
1. PRs #133, #135, #136: [ready] ALL PASSING + APPROVED + CLEAN/MERGEABLE — awaiting human merge (10d+). Watcher spent 80+ corrective actions on branch updates.
...
- Evolve HEALTHY — max-turns 55, 6/29 (20.7%) exceed. 6h cadence confirmed.
- Watcher HEALTHY — max-turns 50, 0/92+ exceed. Turns 19-32 recent. Haiku fallbacks fully resolved — last 50+ runs Opus (3/168 total, 1.8%). 11 consecutive all-clears as of Apr 12 22:49.
...
- Dependabot PRs: #133/#135/#136 APPROVED, ALL PASSING, CLEAN/MERGEABLE. Ready for human merge 10d+. Watcher skips branch updates when merge state CLEAN.
...
- Token utilization: evolve 6/29 exceed 55 (20.7%). Watcher 0/92+ exceed 50, turns 19-32 recent. All Opus, 3/168 Haiku (1.8%). HEALTHY.
