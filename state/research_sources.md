...
- **Added:** 2026-03-20 (seed) | **Last deep:** 2026-03-26T21:16 | **Pattern hits:** 9 | **SHA:** 3d52382
- **Notes:** Most productive source so far. 9 pattern hits across v0.9.7-v0.11.18.2. SHA 1b60acd→3d52382: changed since last scan. All recent patterns Codex/interactive-session specific. 14th consecutive PH with 0 adoptable patterns from this source. Pattern yield exhausted for our CI-based harness.
...
- **Added:** 2026-03-20 (seed) | **Last deep:** 2026-03-26T09:28 | **Pattern hits:** 0 | **SHA:** 1472caa
- **Notes:** SHA 6706361→1472caa (changed, likely ticker 18th+). 0 pattern hits across 18+ observations. Low-value for PATTERN_HUNT; retain for HORIZON_SCAN cross-reference only.

### bytedance/deer-flow
- **Why:** Multi-agent orchestration patterns from a major tech company
- **Look for:** Agent coordination, state management, tool orchestration, LLM provider patterns
- **Added:** 2026-03-21 (seed) | **Last deep:** 2026-03-26T09:28 | **Pattern hits:** 1 | **SHA:** 8ae0235
- **Notes:** Very active (5+ commits/day). SHA 1c542ab→8ae0235. GuardrailMiddleware covered by #67. ACP agent tool integration (auto_approve_permissions, harness/app split) — Python/LangGraph-specific. 0 harness patterns across 8+ consecutive deep-dives. Lowest deep-dive priority.
...
- **Notes:** v10.6.2 active (Mar 21). SHA a656af2 unchanged (9th consecutive). Compress-filter-inject pipeline more sophisticated than our state/ read/write. Could improve project_state.md context management. 0 concrete patterns after 32 obs — fundamentally different approach.
...
- **Notes:** SHA 9df4731 unchanged (8th consecutive). 34+ plugins with formal SKILL.md standard. skill-improver quality loop. Codex compatibility layer. Pattern hit: SKILL.md quality standard (issue #68). Key reference for #66.
...
- **Added:** 2026-03-23 (horizon scan) | **Observations:** 39 | **First seen:** 2026-03-23
- **Notes:** SHA 367c4e0→3503d95 (changed). v8.10.0+: 1,328+ skills. NPX installer, bundles by role. Confirms direction of #66. 0 harness patterns.
...
- **Notes:** v2.29.0. SHA bb3a21a unchanged (8th consecutive). Validates markdown-as-memory, SKILL.md format with i18n. Active community (115+ PRs).
...
- **Notes:** SHA 49840c2 unchanged (9th consecutive). 1 pattern hit (multi-agent review quality gate). Self-learning pattern similar to our feedback-learner. evaluate-session.sh for session outcomes.
